...
public class ModelView extends Layout {
    ...
    private JButton bttn_modelsave;
    private Model model;
    ...
    public ModelView(Model model) {
        ...
        //ComboBoxlara markaları eklemek için.
        ...
        //Modelin ID'si sıfırdan farklıysa tabloya seçilenleri getir.
        ...
        this.bttn_modelsave.addActionListener(e -> {
            if (Helper.isFieldListEmpty(new JTextField[]{this.fld_model_name, this.fld_model_year})) {
                ...
                //ID'si 0'dan farklıysa update işlemidir. Değilse ekleme işlemidir.
                if (this.model.getId() != 0) {
