...
public class BookingView extends Layout {
    ...
    public BookingView(Car selectedCar, String strt_date, String fnsh_date) {
        ...
        //Seçilen arabanın plakası,markası ve modelini getiriyoruz.
        ...
        //TEST İÇİN
        this.fld_book_name.setText("Abre");
        this.fld_book_idno.setText("1234");
        this.fld_book_mail.setText("mail");
        this.fld_book_mpno.setText("0505");
        this.fld_book_prc.setText("200");
        this.txta_book_note.setText("not");


        //Booking tablosundaki Kaydet işlemini aktif hale getiriyoruz.
